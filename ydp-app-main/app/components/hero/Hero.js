...
const Hero = () => {
  return (
    ...
    <div className="mx-auto max-w-7xl px-6 lg:px-8">
        ...
        <h2 className="sm:text-5xl text-3xl mt-5 text-center bg-green-500 font-bold p-2">ALL INDIA YOUTH DEVELOPMENT PARTY</h2>
        <h2 className="sm:text-5xl text-3xl  text-center bg-yellow-200 font-bold p-2" style={{lineHeight: '55px'}}>அனைத்து இந்திய இளைஞர்கள் முன்னேற்ற கட்சி</h2>
      
        <p className="text-center text-xl mt-6">இன்றைய இளைஞர்கள் இந்தியாவின் வருங்கால தூண்கள்!</p>
      ...
      <button type="button" className="btn-outline-primary transition duration-300 ease-in-out focus:outline-none focus:shadow-outline border-2 border-green-700 hover:bg-green-700 text-green-700 hover:text-white font-semibold py-2 px-4 rounded mt-8 text-lg items-center inline-flex " onClick={() => (window.location.href = "/registerpage")} ><span className='pr-2'>Register/உறுப்பினராக</span><FaArrowRightLong/></button>
        ...
        <div className="mt-16 flow-root sm:mt-16">
            <div
                className="-m-2 rounded-sm bg-gray-900/5 p-2 ring-1 ring-inset ring-gray-900/10 lg:mx-72 -mt-10 lg:rounded-sm lg:p-4">
